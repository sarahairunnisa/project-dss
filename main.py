...
def main():
    ...
    weight = [0] * 7
    impact = [0] * 7
    st.markdown("<h1 style='text-align: center; color: black;'>Rekomendasi <span style='color: #e69ded;'>Laptop</span> Menggunakan TOPSIS Method</h1>", unsafe_allow_html=True)
